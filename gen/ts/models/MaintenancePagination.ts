...
export interface MaintenancePagination {
   ...
   *
   * @type {number}
   * @memberof MaintenancePagination
   */
  total?: number;
  /**
   *
...
export function MaintenancePaginationFromJSON(
  json: any
): MaintenancePagination {
  return MaintenancePaginationFromJSONTyped(json, false);
}

export function MaintenancePaginationFromJSONTyped(
  json: any,
  ...
  return {
    ...
    items: !exists(json, 'items')
      ? undefined
      : (json['items'] as Array<any>).map(MaintenanceFromJSON),
  };
}

export function MaintenancePaginationToJSON(
  value?: MaintenancePagination | null
): any {
  if (value === undefined) {
    return undefined;
  }
  ...
  return {
    ...
    items:
      value.items === undefined
        ? undefined
        : (value.items as Array<any>).map(MaintenanceToJSON),
  };
}
